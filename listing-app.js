...
if(!id){
  ...
  try{
    ...
    if(!snap.exists()){
      target.innerHTML='<div class="listing-error"><h1>Listing not found</h1><p>This item may have been removed.</p><a class="btn btn-teal" href="shop.html">Back to Shop</a></div>';
    }else{
